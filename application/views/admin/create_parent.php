...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url(); ?>view/parent_list">List of Parents</a></li>
    ...
    <section class="content">
      <div class="row">
          <div class="col-xs-12">
            <form role="form" id = "formUser" action = '<?php echo base_url(); ?>admin_controller/create_parent' enctype="multipart/form-data" name="Form_register">
...
<script src="<?php echo base_url();?>common/admin_js/create_parent.js"></script>