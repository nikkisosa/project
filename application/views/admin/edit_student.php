...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          <div class="col-xs-12">
            <form role="form" id = "formUser" action = '<?php echo base_url(); ?>admin_controller/edit_student' enctype="multipart/form-data" name="Form_register">
...
<script src="<?php echo base_url();?>common/admin_js/edit_suser.js"></script>