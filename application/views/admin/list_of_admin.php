...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          ...
          <a href="<?php echo base_url(); ?>view/create_admin" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus"></span></a>
                  ...
                  <?php 
                    try {
                      ...
                      foreach ($users as $user) { ?>
                        <!--<input type = "submit" class = "userInfo" id = "userInfo<?php echo $hid; ?>" value = '{"fname":"<?php echo $user['fname']; ?>","lname":"<?php echo $user['lname']; ?>","img":"<?php echo $user['img']; ?>","mobile_no":"<?php echo $user['mobile_no']; ?>","email":"<?php echo $user['email']; ?>","type":"Administrator","img":"<?php echo $user['img']; ?>"}' />-->
                        <tr>
                          <td><?php echo $user['account_id']; ?></td>
                          <td><?php 
                              $u = '';
                              $d = '';
                              $elink = base_url().'view/edit_admin/'.$user['account_id'];
                              if($user['account_id'] == $this->session->userdata('account_id')) {
                                $u = ' (You)';
                                $d = 'disabled';
                                $elink = '#';
                              }
                              echo $user['fname'].' '.$user['lname'].$u; ?>
                          </td>
                          ...
                          <td style = "width:200px;">
                              ...
                              <center>
                                  <div class="btn-group">
                                      <a href="<?php echo $elink; ?>" class="btn btn-primary" role="button" <?php echo $d; ?>><span class="glyphicon glyphicon-edit"></span></a>
                                       <button id = '{"link":"<?php echo base_url().'admin_controller/delete_user'; ?>","id":"<?php echo $user['account_id']; ?>"}' type="button" class="btn btn-danger btnDelete" data-toggle="modal" data-target="#deleteModal" <?php echo $d; ?>>
                                          <i class="glyphicon glyphicon-remove"></i>
                                       </button>
                                       <button type="button" class="btn btn-warning btnShowInfo" data-toggle="modal" data-target="#infoModal" id = '{"fname":"<?php echo $user['fname']; ?>","lname":"<?php echo $user['lname']; ?>","img":"<?php echo $user['img']; ?>","mobile_no":"<?php echo $user['mobile_no']; ?>","email":"<?php echo $user['email']; ?>","type":"Administrator","img":"<?php echo $user['img']; ?>"}'>
                                          <i class="fa fa-eye"></i>
                                      </button>
                                  </div>
                              </center>
