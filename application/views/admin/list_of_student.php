...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          ...
          <a href="<?php echo base_url(); ?>view/create_student" class="btn btn-success" role="button"><span class="glyphicon glyphicon-plus"></span></a>
                ...
                <?php
                    try {
                      ...
                      foreach ($users as $user) { ?>
                        <!--<input type = "hidden" id = "userInfo<?php echo $hid; ?>" value = '{"fname":"<?php echo $user['fname']; ?>","lname":"<?php echo $user['lname']; ?>","img":"<?php echo $user['img']; ?>","mobile_no":"<?php echo $user['mobile_no']; ?>","email":"<?php echo $user['email']; ?>","type":"Student","img":"<?php echo $user['img']; ?>"}' />-->
                        <tr>
                          ...
                          <td style = "width:200px;">
                              ...
                              <center>
                                  <div class="btn-group">
                                      <a href="<?php echo base_url(); ?>view/edit_student/<?php echo $user['account_id']; ?>" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-edit"></span></a>
                                       ...
                                       <button type="button" id =  '{"fname":"<?php echo $user['fname']; ?>","lname":"<?php echo $user['lname']; ?>","img":"<?php echo $user['img']; ?>","mobile_no":"<?php echo $user['mobile_no']; ?>","email":"<?php echo $user['email']; ?>","type":"Student","img":"<?php echo $user['img']; ?>"}' class="btn btn-warning btnShowInfo" data-toggle="modal" data-target="#infoModal" >
                                          <i class="fa fa-eye"></i>
                                      </button>     
                                  </div>
                              </center>
