    ...
    <section class="content" >
      <div class="row">
          ...
          <div class="panel panel-default">
            ...
            if(empty($announcement)){
              ...
              foreach ($announcement as $value) {
                if($value['priority'] == 'yes')
                {
                  ?>
                    <div class="panel panel-default" style="padding:2%;">
                      <div class="panel-heading" style="background-color: #32cd32;"><strong><?php echo $value['title'];?></strong><p class="pull-right"><?php echo $value['date_created'];?></p></div>
        ...
        <div class="col-lg-4" style="margin-top: 5%;">
          <div class="panel panel-default">
            <div class="panel-heading">Online user's</div>
            ...
            if(empty($online)){
              ...
              foreach ($online as $value) {
                  ?>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:1%;margin-left:0%; padding:2%;height: 8vh; border:1px solid #dfdfdf;">
                      <div>
                        <label class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="color:#7ec0ee"><img src="<?php echo base_url().$value["img"];?>" class="" style="width: 30px;height:30px;"> <?php echo $value['name'];?>
                          <?php
                            if($value['name'] == $this->session->userdata('name')){
                              echo '(you)';
                            }else{
                              echo '('.$value['type'].')';
                            }
          ...
          <div class="panel panel-default">
            ...
            if(empty($threads)){
                        ...
                        foreach ($threads as $value) {
                            ...
                            echo '<div class="info-box col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-top:1%;margin-left:0%; padding:0%;">';
                            ...
                            echo '<label class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><i>Thread Start: </i>'.$value['name'].'('.$value['type'].')<i class="pull-right">'.$value['date_created'].'</i></label>';
