              ...
              <li class="user-footer">
                <div class="pull-left">
                  ...
                  if($this->session->userdata('role') == 'admin'){
                    ...
                    ?>
                      <a href="<?php echo base_url();?>view/teacher" class="btn btn-default btn-flat">Profile</a>
                    <?php
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <?php
              if($this->session->userdata('role') == 'admin'){
                ?>
                <li><a href="<?php echo base_url();?>forum/category_list"><i class="fa fa-circle-o"></i>List of Category</a></li>
                <?php 
              }
            ?>
            ...
            if(!empty($category)){
              foreach ($category as $value) {
                echo '<li><a href="'.base_url().'forum/category?id='.$value['category_id'].'&category='.$value['category'].'"><i class="fa fa-circle-o"></i>'.$value['category'].'</a></li>';
              }
            }else{
        ...
        <li>
          <a href="<?php echo base_url();?>forum/post">
            <i class="fa fa-question-circle"></i> <span>Post Question</span>
          </a>
        </li>
      </ul>
    </section>
